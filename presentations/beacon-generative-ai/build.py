...
<nav class="contents" aria-label="Talk chapters"><a href="#delegation">Adoption</a><a href="#virtues">The workbench</a><a href="#timeline">Applications</a><a href="#limits">Discussion</a><a href="#deep-dives">Deep Dives</a><a href="#sources">Source trail</a><a href="#acknowledgements">Acknowledgements</a></nav>
...
parts.append('''</div><p class="disclosure">Sources, repository documentation, and selected public artifacts were checked during preparation. The speaker supplied the firsthand account of internal adoption at an unnamed company. It is separate from RealPage’s public statements. The date of first personal CiteGeist use still needs confirmation.</p></section>''')
...
notes=['# Generative AI, with receipts.','', 'Wesley R. Elsberry · Michigan State University BEACON large group','', '**Status:** speaker review draft. Default timing: 30-minute core plus discussion.','', '## Speaker input still needed','', '- Confirm meeting date and available time.','- Confirm date and anecdote of first CiteGeist use; repository history begins 19 March 2026.','', '## Suggested pacing','', '- Opening, adoption, and firsthand experience: 9 minutes.','- Values and workbench: 9 minutes.','- Applications, including the TalkOrigins update workflow: 8 minutes.','- Limits and discussion setup: 4 minutes.','- For a shorter talk, keep sections 1–2, 4–6, 8–10, 12, 14–15, and 21.','- Deep Dives are optional discussion material, outside the 30-minute core. Links return to the section that opened the dive.','']
for s in all_scenes:
