...
parts.append('''</div><p class="disclosure">Prepared with generative-AI assistance. Sources, repository documentation, and selected public artifacts were checked during preparation. The speaker’s personal RealPage assessment and first-use timeline are awaiting confirmation. No company, university, or project endorsement is implied. Social-preview artwork was generated with AI.</p><a href="#opening">Return to the beginning ↑</a></section></main>
