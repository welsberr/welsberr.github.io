...
<nav class="contents" aria-label="Talk chapters"><a href="#delegation">Adoption</a><a href="#virtues">The workbench</a><a href="#timeline">Applications</a><a href="#limits">Discussion</a><a href="#deep-dives">Deep Dives</a><a href="#sources">Source trail</a></nav>
...
parts.append('''</optgroup><option value="sources">Sources</option></select><button id="next" aria-label="Next section">→</button><button id="notes" aria-pressed="false">Notes</button><button id="fullscreen">Full screen</button><button id="print">Print</button></nav><div class="sr-only" id="section-status" aria-live="polite"></div>
